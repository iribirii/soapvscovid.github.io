...
class Cell {
    ...
    show() {
    	...
    	if (this.t == "C") {
            ...
            stroke(50, 140, 5);                         // green stroke with no transparency
            fill(125, 235, 155);                           // green filling with transparency
            rect(0, -this.r/2, -this.r/3, this.r);
            stroke(45, 75, 20);                         // green stroke with no transparency
            fill(50, 140, 5);                           // green filling with transparency
        ...
        // DNA
    		...
    		fill(150,50,100, 200);                          // dark red filling with transparency 
    		circle(this.pos.x, this.pos.y, this.r);
    	} else if (this.t == "S") {
    		stroke(100,100,255);                            // dark blue stroke with no transparency
    		fill(100,100,255, 200);                         // dark blue filling with transparency
    		circle(this.pos.x, this.pos.y, this.r);
    	}
    }
}
